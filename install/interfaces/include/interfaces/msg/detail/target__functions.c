...
{
  interfaces__msg__Target * msg = (interfaces__msg__Target *)malloc(sizeof(interfaces__msg__Target));
  if (!msg) {
    return NULL;
  }
...
interfaces__msg__Target__Sequence__init(interfaces__msg__Target__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__msg__Target *)calloc(size, sizeof(interfaces__msg__Target));
    if (!data) {
      return false;
    }
...
{
  interfaces__msg__Target__Sequence * array = (interfaces__msg__Target__Sequence *)malloc(sizeof(interfaces__msg__Target__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interfaces__msg__Target__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__msg__Target * data =
      (interfaces__msg__Target *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__Target__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__msg__Target__fini(&data[i]);
        }
        free(data);
        return false;
      }
