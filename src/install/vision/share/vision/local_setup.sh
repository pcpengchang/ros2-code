...
: ${AMENT_CURRENT_PREFIX:="/home/pengchang/ws/src/install/vision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vision/environment/library_path.sh"
