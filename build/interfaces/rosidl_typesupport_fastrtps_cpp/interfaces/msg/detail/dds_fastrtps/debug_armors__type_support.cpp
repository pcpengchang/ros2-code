...
#include "interfaces/msg/detail/debug_armors__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces::msg::DebugArmor &,
...
cdr_serialize(
  const interfaces::msg::DebugArmors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::DebugArmors & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DebugArmor(
...
{
  auto typed_message =
    static_cast<const interfaces::msg::DebugArmors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::DebugArmors *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_DebugArmors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, DebugArmors)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_DebugArmors__handle;
}
