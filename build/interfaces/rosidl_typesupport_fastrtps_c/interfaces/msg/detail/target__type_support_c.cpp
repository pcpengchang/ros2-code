...
#include "interfaces/msg/detail/target__rosidl_typesupport_fastrtps_c.h"
...
using _Target__ros_msg_type = interfaces__msg__Target;
...
static uint32_t _Target__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Target(
...
{
  return max_serialized_size_interfaces__msg__Target(
    full_bounded, 0);
}
