...
#include "interfaces/msg/detail/debug_light__rosidl_typesupport_fastrtps_c.h"
...
using _DebugLight__ros_msg_type = interfaces__msg__DebugLight;
...
static uint32_t _DebugLight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__DebugLight(
...
{
  return max_serialized_size_interfaces__msg__DebugLight(
    full_bounded, 0);
}
